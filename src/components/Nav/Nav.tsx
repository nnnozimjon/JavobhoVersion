...
const Nav = () => {
  ...
  return (
    <div className="sm:w-[300px] sm:min-w-[300px] sm:flex grid sm:h-screen sm:justify-between sm:flex-col sm:border-r-[1px] sm:border-invisible">
      ...
      <div className="w-full bg-white sm:h-full h-fit p-0 sm:pl-[30px] sm:px-[20px] sm:block grid grid-cols-4 gap-4 sm:relative sm:border-none fixed bottom-0 border-t border-invisible z-50">
